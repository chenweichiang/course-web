...
export const WEEKS = [
  { w: 1, phase: '壹', title: '導論', note: 'AI 時代為什麼還要學寫程式；p5.js 第一張畫布' },
  { w: 2, phase: '壹', title: '變數與互動', note: 'mouseX/mouseY、random()、會呼吸的圖形' },
  { w: 3, phase: '壹', title: '條件與事件', note: 'if/else、滑鼠鍵盤事件、狀態切換' },
  { w: 4, phase: '壹', title: '迴圈與重複之美', note: 'for 迴圈、網格、一行迴圈長出一整面牆' },
  { w: 5, phase: '壹', title: '函式與視覺語彙', note: '參數化：把「一朵花」變成「任何一朵花」' },
  { w: 6, phase: '壹', title: '陣列＋實作檢核', note: '當場限時完成小題，只能查官方文件', flag: '檢核' },
  { w: 7, phase: '貳', title: '一顆粒子的誕生', note: 'class、constructor、update()/display()' },
  { w: 8, phase: '貳', title: '一千顆粒子', note: '陣列 × 物件＝粒子系統：煙、雨、雪、星塵' },
  { w: 9, phase: '貳', title: '繼承與多型', note: 'extends/super，同一個系統三種行為' },
  { w: 10, phase: '貳', title: '向量、力與群集', note: 'p5.Vector、吸引排斥、flocking 魚群鳥群' },
  { w: 11, phase: '貳', title: '期中發表', note: '物件導向生成藝術小品＋口頭 critique', flag: '發表' },
  { w: 12, phase: '參', title: 'AI 協作第一課', note: 'prompt→驗證→逐行手打；建立 AI 使用紀錄', flag: '檢核' },
  { w: 13, phase: '參', title: '重混與改造', note: 'fork 別人的碼（包括 AI 的碼），揭露倫理' },
  { w: 14, phase: '參', title: 'AI 當媒材', note: 'ml5.js 手勢／姿態偵測，身體變成控制器' },
  { w: 15, phase: '參', title: '期末專題製作', note: '一對一 studio time' },
  { w: 16, phase: '參', title: '期末展演＋答辯', note: '公開展示；解釋你的碼＋AI 用在哪', flag: '展演' },
]
...
export const AI_RULES = [
  ...
  { t: '階段壹（W1–6）', d: '作業禁止提交 AI 生成的程式碼。參考了 AI 的說明，須逐行手打並註明。' },
  { t: '階段貳（W7–11）', d: 'AI 可用於除錯與解釋，不可代寫整段功能；使用須在 AI 揭露欄註明。' },
  { t: '階段參（W12–16）', d: '全面開放協作：完整揭露（工具／日期／prompt／採用範圍），且答辯時能解釋任何一段碼。解釋不出來的段落不計分。' },
...
export const TOOLS = [
  ...
  { name: 'Claude Pro（自行訂閱）', role: '階段貳–參的 AI 夥伴', cost: '約 US$20/月', note: 'W7 之後再訂閱即可，一學期約訂 2–3 個月', main: true },
