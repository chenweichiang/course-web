...
export const WEEKS = [
  ...
  },
  {
    ...
    bring: [
      '看：《Life After People》官方播放清單任選一集，再看《The Future Is Wild》官方預告片（兩者連結都在案例庫「沒有人類之後」），注意它們怎麼用時間軸推演，用案例庫的四個問題寫進 notes.md',
...
export const MILESTONE_GUIDE = [
  {
    id: 'M0', name: '裝備', flag: null, when: '第 1–2 週（9/10、9/17）', due: '9/24（四）上課前',
...
export const SUBMIT_STEPS = [
  ...
  { t: '截止前交上去', d: '各站截止：M0 9/24、M1 10/1、M2 10/15、M3 11/12、M4 12/3、M5 12/17，都是當天上課前（15:30）。M6 在 12/24 開園前交作品與導覽簡報，反思與 AI 揭露當天 23:59 前補齊。commit 的時間戳就是交付紀錄，你的每一步嘗試都是過程的證據。' },
