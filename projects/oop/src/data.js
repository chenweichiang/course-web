...
export const CALENDAR = {
  intro:
    '課程進行以里程碑為主，日期只是讓你知道自己走到哪，全班同步的站點只有簽核、檢核、發表會、開園四個。時段依本學期行事曆換算：開學 9/7、共 16 週、期末考週 12/21 到 12/24，本課零考試，開園展演就排在那一週。',
  offdays:
...
export const MILESTONE_GUIDE = [
  ...
  {
    id: 'M1', name: '世界', flag: '簽核', when: '第 2–4 週，10/2 前完成簽核',
    ...
    steps: [
      ...
      '報告完把研究報告交給老師簽核，通過才開始設計物種，簡報檔一併放進 m1-world/。',
    ],
    checks: [
      '有明確的時間點與棲地',
      '至少五個點得開的來源連結',
