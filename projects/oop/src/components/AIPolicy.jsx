  ...
  return (
    <div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {AI_RULES.map((r, i) => (
          <div key={r.t} className="border-2 border-neutral-900 rounded-lg bg-white p-5">
        ...
        <div className="border-2 border-neutral-900 rounded-lg bg-amber-50 p-5">
          <div className="font-mono text-sm text-amber-700 mb-2">為什麼這樣設計</div>
          <p className="heti text-sm leading-relaxed text-neutral-800">
