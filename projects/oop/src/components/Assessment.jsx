  ...
  return (
    <div className="grid lg:grid-cols-[2fr_1fr] gap-8">
      <div className="space-y-4">
        {ASSESSMENT.map((a) => (
          <div key={a.item} className="nb nb-hover bg-white p-4">
            <div className="flex items-center justify-between gap-4 mb-2">
              <span className="font-bold">{a.item}</span>
              <span className="font-mono font-bold text-lg whitespace-nowrap">{a.pct}%</span>
            </div>
            <div className="h-3 border-2 border-neutral-900 bg-white overflow-hidden mb-2">
      ...
      <div className="space-y-5">
        <div className="nb bg-neutral-900 text-white p-5">
